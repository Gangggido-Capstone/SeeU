...
# CSV 파일 경로
csv_file = "Data\\GazeData\\0gkPFSvVvFw_2024-10-12-16-50-03.csv"
dt = "2024-10-12-16-50-03"
...
video_only = f"analysis/input_video/temp/{video_id}_video_only.mp4"  # 비디오 파일 경로
audio_only = f"analysis/input_video/temp/{video_id}_audio_only.m4a"  # 오디오 파일 경로
...
video_with_points = f"analysis/input_video/temp/{video_id}_points.mp4"
...
#  ==========================================================  #
os.makedirs(f"analysis/{video_id}/points", exist_ok=True)
out_video = f"analysis/{video_id}/points/{video_id}_{dt}.mp4"
